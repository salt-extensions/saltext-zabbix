...
src_dir = repo_path / "src" / "saltext" / "saltext-zabbix"
...
for path in Path(__file__).parent.parent.joinpath("src/saltext/saltext-zabbix/").glob("*/*.py"):
...
"""
    ...
    all_rst.write_text(
        f"""
.. all-saltext.saltext-zabbix.{kind}:
